"""
Django settings for lucky_wood_42968 project.
...
ROOT_URLCONF = 'lucky_wood_42968.urls'
...
WSGI_APPLICATION = 'lucky_wood_42968.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_wood_42968 API",
    "DESCRIPTION": "API documentation for lucky_wood_42968 App",
    "VERSION": "v1",
}
